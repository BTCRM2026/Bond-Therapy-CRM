...
export default async function AccessDeniedPage() {
  ...
  return (
    ...
    >
      <section className="mx-auto mt-8 max-w-lg rounded-xl border bg-white p-6 text-center shadow-[0_8px_24px_rgba(15,23,42,0.06)] sm:p-8">
        ...
        <Link href="/dashboard" className="mt-6 inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-brand px-4 text-[13px] font-semibold text-white transition-colors hover:bg-brand-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/25 sm:h-10">
