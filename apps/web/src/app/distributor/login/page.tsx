...
export default function DistributorLoginPage() {
  const label = portalLabel("DISTRIBUTOR");
  return (
    <main
      ...
      <section className="grid h-[calc(100svh-24px)] min-h-0 w-full max-w-[600px] overflow-hidden rounded-xl border border-white/70 bg-white/95 shadow-[0_24px_60px_rgba(23,32,51,0.12),0_4px_16px_rgba(23,32,51,0.06)] backdrop-blur-sm sm:h-[calc(100svh-40px)] sm:max-h-[760px] lg:h-[calc(100svh-64px)] lg:max-h-[720px] lg:min-h-[620px] lg:max-w-[1120px] lg:grid-cols-[0.92fr_1.08fr] lg:gap-4 lg:p-4">
        ...
        >
          ...
          <div className="relative max-w-[430px] pb-1 text-white">
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/75">Regional stock and fulfillment</p>
            <h1 className="text-[28px] font-semibold leading-[1.15] tracking-[-0.035em] sm:text-[30px] lg:text-[32px] xl:text-[36px]">Fulfill orders from your own stock, in one place.</h1>
            <p className="mt-3 max-w-[470px] text-sm leading-6 text-white/80 lg:mt-4">Track incoming orders, manage stock, and request replenishment from Bond Therapy.</p>
