...
function RateForm({ row, period, onClose, onSaved }: { row: TeamRow; period: { month: number; year: number }; onClose: () => void; onSaved: () => Promise<void> }) {
  ...
  return <div className="fixed inset-0 z-50 grid place-items-end bg-foreground/40 p-0 backdrop-blur-[1px] sm:place-items-center sm:p-4" role="dialog" aria-modal="true" aria-label="Set incentive rate">
